...
def process(mlist, msg, msgdata):
    ...
    if mlist.anonymous_list:
        ...
        return
    # If we're coming from a parent list,assume that DMARC has already been done if needed
    if msg['X-Mailman-Parent-List'] is not None:
        log.error("Parent list found")
        return
